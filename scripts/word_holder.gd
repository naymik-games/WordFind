...
func _on_grid_update_word_status(type):
		if type == 0:
			#build color
			label.set("theme_override_colors/font_color", Color.html("#142216"))
		elif type == 1:
			#found word
			label.set("theme_override_colors/font_color", Color.html("#38563c"))
		elif type == 2:
			#not a word
			label.set("theme_override_colors/font_color",Color.html("#ff0000"))
		elif type == 3:
			#already found
			label.set("theme_override_colors/font_color", Color.html("#0000ff"))
